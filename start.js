...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 10,status: 200, thumbnail: fs.readFileSync(`./storage/image/thumb.jpg`), surface: 200, message: `)-----[KN-BO]-----(`, orderTitle: 'KiNO', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
rifza.browserDescription = [ 'KN-BOT', 'Aloha', '5.4' ]
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
rifza.on('connecting', () => {
start('2', 'Mengkoneksikan ke ISEKAI...')
})
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
rifza.on('open', () => {
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->   
console.clear()
console.log(bgcolor('KN-BOT ©WhatsApp_Bot • Created By > [ ®KiNO ]\n-------> Ready to use❗', 'gray'))
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
await sleep(15000)
...
footerText: `©Created by KiNO` ,
buttons: buttonss,
headerType: 1
}
rifza.sendMessage(`6289602518223@s.whatsapp.net`,  buttonMessagee, MessageType.buttonsMessage,{
        caption: '[ • KN-BOT • ]',
        "contextInfo": {
            text: 'hi',
...
rifza.sendMessage(callerId, { displayname: `${Options.NamaOwner}`, vcard: vcard}, MessageType.contact, {contextInfo: { externalAdReply:{title: `Creator ${Options.NamaBot}`,body:"",previewType:"PHOTO",thumbnail:fs.readFileSync(`./storage/image/thumb.jpg`),sourceUrl:`https://wa.me/6289602518223?text=Assalamualaikum`}}})
await sleep(5000)
